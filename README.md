...
# Dieses Projekt wird nicht weiter gepflegt, da die Einbindung über 868MHz sinnvoller erscheint. <br>Nähere Informationen gibts [hier](https://github.com/jp112sdl/Beispiel_AskSinPP).<br> Im [examples](https://github.com/jp112sdl/Beispiel_AskSinPP/tree/master/examples)-Ordner befinden sich die Projektdateien für die Sensoren
